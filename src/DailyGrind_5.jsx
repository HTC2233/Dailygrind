...
const TRAITS = [
  ...
  { id: "creativity",   label: "Creativity",      icon: "?Ž¨",  color: "#f97316" },
  { id: "music",        label: "Music Talent",    icon: "?Žµ",  color: "#a855f7" },
...
const BADGES = [
  ...
  { id: "five",       icon: "?Ž³", label: "On a Roll",         desc: "Completed 5 tasks total",                 check: s => s.totalDone >= 5 },
        ...
        {total > 0 && view === "tasks" && (
          <div style={{ marginTop: 12 }}>
            <div style={{ display: "flex", justifyContent: "space-between", fontSize: 12, marginBottom: 5 }}>
              <span style={{ color: "#7070a0" }}>{done} done Â· {active} remaining Â· {tasks.filter(t => t.carriedOver).length} moved forward</span>
    ...
    <div style={{ padding: "14px 20px" }}>
      ...
      {result && (
        <div style={{ animation: "fadeIn .4s" }}>
          ...
          {/* Top 20% */}
          <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: 2, color: "#ef4444", marginBottom: 10 }}>?Ž¯ CRITICAL 20% ??DO THESE FIRST</div>
          {result.schedule
              ...
              <div key={trait.id} style={{ background: "#16161f", border: "1px solid " + trait.color + "30", borderRadius: 12, padding: "12px 14px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 6 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 10, color: "#555570" }}>Lv.{tlv} Â· {xp} XP</div>
                  </div>
                </div>
